                  ...
                  const html = `
                      <div class="ds-ability-card">
                        ...
                        <div class="ds-ability-card-upper-properties">
                          ${data.keywords ? `<div>${data.keywords}</div>` : ""}
                          ${data.type ? `<div>${data.type}</div>` : ""}
                        </div>
                        <div class="ds-ability-card-lower-properties">
                          ${data.distance ? `<div>📏${data.distance}</div>` : ""}
                          ${data.target ? `<div>🎯${data.type}</div>` : ""}
                        </div>
                        ${data.effects ? data.effects.map((element: any) => {
                    if (element.roll) {
                      const rollContainer =
                        `<div class="ds-ability-card-rolls ds-ability-card-effect">
                          ...
                          <div class="ds-ability-card-roll-line"><div class="tier-key-container t3"><div class="key-body t3"><div class="key-body-text">17+</div></div></div><span><p>${element.t3 ?? element["17+"] ?? "-"}</p></span></div></div>`
